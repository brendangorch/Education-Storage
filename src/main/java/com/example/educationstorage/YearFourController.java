...
public class YearFourController implements Initializable {
    ...
    public void setAdapters(YearFourAdapter yearFourAdapt) throws SQLException {
    ...
    public void populateTreeView() throws SQLException{
        ...
        ObservableList<String> courseNamesList = yearFourAdapter.returnListOfCourseNames();
        ...
        for (String courseName: courseNamesList) {
            ...
            int term = yearFourAdapter.getTermNumber(courseName);
            double percentGrade = yearFourAdapter.getPercentGrade(courseName);
        ...
        if (editFlag) {
            ...
            try {
                ...
                if (newCourseGrade >= 0 && newCourseGrade <= 100 && !courseTextField.getText().isBlank() &&
                    ...
                    yearFourAdapter.changePercentGrade(currentCourseName, newCourseGrade);
                    yearFourAdapter.changeCourseName(currentCourseName, newCourseName);
                    yearFourAdapter.changeWeight(currentCourseName, newWeight);
            ...
            try {
                ...
                if (gradePercent >= 0 && gradePercent <= 100 && !courseTextField.getText().isBlank()&&
                    ...
                    if (!yearFourAdapter.courseNameTaken(courseNameEntered)) {
                        ...
                        if (termSelected.getValue().equals("First Term: Fall")) {
                            yearFourAdapter.insertCourse(yearFourAdapter.getMaxId() + 1, courseNameEntered, 1, gradePercent, weight);
                        }
                        if (termSelected.getValue().equals("Second Term: Winter")) {
                            yearFourAdapter.insertCourse(yearFourAdapter.getMaxId() + 1, courseNameEntered, 2, gradePercent, weight);
                        }
                        if (termSelected.getValue().equals("Third Term: Summer")) {
                            yearFourAdapter.insertCourse(yearFourAdapter.getMaxId() + 1, courseNameEntered, 3, gradePercent, weight);
                        }
    ...
    public void deleteCourse() throws SQLException {
        ...
        yearFourAdapter.deleteCourse(deleteUntilCharacter(item.getValue(), '-'));
    ...
    public void editCourse() throws SQLException {
        ...
        gradeTextField.setText(String.format("%.1f", yearFourAdapter.getPercentGrade(deleteUntilCharacter(item.getValue(), '-'))));
        weightComboBox.setValue(yearFourAdapter.getWeight(deleteUntilCharacter(item.getValue(), '-')));

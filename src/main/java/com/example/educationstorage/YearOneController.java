...
public class YearOneController implements Initializable {
    ...
    public void setAdapters(YearOneAdapter yearOneAdapt) throws SQLException {
    ...
    public void populateTreeView() throws SQLException{
        ...
        ObservableList<String> courseNamesList = yearOneAdapter.returnListOfCourseNames();
        ...
        for (String courseName: courseNamesList) {
            ...
            int term = yearOneAdapter.getTermNumber(courseName);
            double percentGrade = yearOneAdapter.getPercentGrade(courseName);
        ...
        if (editFlag) {
            ...
            try {
                ...
                if (newCourseGrade >= 0 && newCourseGrade <= 100 && !courseTextField.getText().isBlank() &&
                    ...
                    yearOneAdapter.changePercentGrade(currentCourseName, newCourseGrade);
                    yearOneAdapter.changeCourseName(currentCourseName, newCourseName);
                    yearOneAdapter.changeWeight(currentCourseName, newWeight);
            ...
            try {
                ...
                if (gradePercent >= 0 && gradePercent <= 100 && !courseTextField.getText().isBlank()&&
                    ...
                    if (!yearOneAdapter.courseNameTaken(courseNameEntered)) {
                        ...
                        if (termSelected.getValue().equals("First Term: Fall")) {
                            yearOneAdapter.insertCourse(yearOneAdapter.getMaxId() + 1, courseNameEntered, 1, gradePercent, weight);
                        }
                        if (termSelected.getValue().equals("Second Term: Winter")) {
                            yearOneAdapter.insertCourse(yearOneAdapter.getMaxId() + 1, courseNameEntered, 2, gradePercent, weight);
                        }
                        if (termSelected.getValue().equals("Third Term: Summer")) {
                            yearOneAdapter.insertCourse(yearOneAdapter.getMaxId() + 1, courseNameEntered, 3, gradePercent, weight);
                        }
    ...
    public void deleteCourse() throws SQLException {
        ...
        yearOneAdapter.deleteCourse(deleteUntilCharacter(item.getValue(), '-'));
    ...
    public void editCourse() throws SQLException {
        ...
        gradeTextField.setText(String.format("%.1f", yearOneAdapter.getPercentGrade(deleteUntilCharacter(item.getValue(), '-'))));
        weightComboBox.setValue(yearOneAdapter.getWeight(deleteUntilCharacter(item.getValue(), '-')));

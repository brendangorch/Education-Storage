...
public class YearFourAdapter {

    // create a connection
    private Connection connection;

    public YearFourAdapter(Connection conn, Boolean reset) throws SQLException {
        connection = conn;
        ...
        if (reset) {
            try {
                ...
                stmt.execute("DROP TABLE YearFour");
        ...
        try {
            // Create the table
            stmt.execute("CREATE TABLE YearFour ("
    ...
    public void insertCourse(int id, String courseName, int term, double percentGrade, double weight) throws SQLException {
        ...
        stmt.executeUpdate("INSERT INTO YearFour (ID, CourseName, Term, PercentGrade, Weight) VALUES (" + id +
    ...
    public void deleteCourse(String courseName) throws SQLException {
        ...
        String sqlStatement = "DELETE FROM YearFour WHERE CourseName = " + "'" + courseName + "'";
        // execute the update
    ...
    public int getMaxId() throws SQLException {
        ...
        String sqlStatement =  "SELECT MAX(ID) FROM YearFour";
    ...
    public ObservableList<String> returnListOfCourseNames() throws SQLException {
        ...
        String sqlStatement = "SELECT * FROM YearFour";
    ...
    public boolean courseNameTaken(String courseName) throws SQLException {
        ...
        // Create a string with a SELECT statement
        String sqlStatement = "SELECT CourseName FROM YearFour";
    ...
    public double getPercentGrade(String courseName) throws SQLException {
        ...
        // Create a string with a SELECT statement
        String sqlStatement = "SELECT PercentGrade FROM YearFour WHERE CourseName = " + "'" + courseName + "'";
    ...
    public int getTermNumber(String courseName) throws SQLException {
        ...
        // Create a string with a SELECT statement
        String sqlStatement = "SELECT Term FROM YearFour WHERE CourseName = " + "'" + courseName + "'";
    ...
    public int getId(String courseName) throws SQLException {
        ...
        // Create a string with a SELECT statement
        String sqlStatement = "SELECT ID FROM YearFour WHERE CourseName = " + "'" + courseName + "'";
    ...
    public double getWeight(String courseName) throws SQLException {
        ...
        // Create a string with a SELECT statement
        String sqlStatement = "SELECT Weight FROM YearFour WHERE CourseName = " + "'" + courseName + "'";
    ...
    public void changeWeight(String courseName, double newWeight) throws SQLException {
        ...
        String sqlStatement = "UPDATE YearFour SET Weight =" + newWeight + "WHERE CourseName =" +
                "'" + courseName + "'";
        // execute update
    ...
    public void changeCourseName(String currentName, String newName) throws SQLException {
        ...
        String sqlStatement = "UPDATE YearFour SET CourseName  =" + "'" + newName + "'" + "WHERE CourseName =" +
                "'" + currentName + "'";
        // execute update
        stmt.executeUpdate(sqlStatement);
    }
    ...
    public void changePercentGrade(String courseName, double newGrade) throws SQLException {
        ...
        String sqlStatement = "UPDATE YearFour SET PercentGrade =" + newGrade + "WHERE CourseName =" +
                "'" + courseName + "'";
        // execute update
        stmt.executeUpdate(sqlStatement);
    }
    ...
    public double getWeightFromId(int Id) throws SQLException {
        ...
        // Create a string with a SELECT statement
        String sqlStatement = "SELECT Weight FROM YearFour WHERE ID = " + Id;

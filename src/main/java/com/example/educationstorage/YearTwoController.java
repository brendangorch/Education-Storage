...
public class YearTwoController implements Initializable {
    ...
    public void setAdapters(YearTwoAdapter yearTwoAdapt) throws SQLException {
    ...
    public void populateTreeView() throws SQLException{
        ...
        ObservableList<String> courseNamesList = yearTwoAdapter.returnListOfCourseNames();
        ...
        for (String courseName: courseNamesList) {
            ...
            int term = yearTwoAdapter.getTermNumber(courseName);
            double percentGrade = yearTwoAdapter.getPercentGrade(courseName);
        ...
        if (editFlag) {
            ...
            try {
                ...
                if (newCourseGrade >= 0 && newCourseGrade <= 100 && !courseTextField.getText().isBlank() &&
                    ...
                    yearTwoAdapter.changePercentGrade(currentCourseName, newCourseGrade);
                    yearTwoAdapter.changeCourseName(currentCourseName, newCourseName);
                    yearTwoAdapter.changeWeight(currentCourseName, newWeight);
            ...
            try {
                ...
                if (gradePercent >= 0 && gradePercent <= 100 && !courseTextField.getText().isBlank()&&
                    ...
                    if (!yearTwoAdapter.courseNameTaken(courseNameEntered)) {
                        ...
                        if (termSelected.getValue().equals("First Term: Fall")) {
                            yearTwoAdapter.insertCourse(yearTwoAdapter.getMaxId() + 1, courseNameEntered, 1, gradePercent, weight);
                        }
                        if (termSelected.getValue().equals("Second Term: Winter")) {
                            yearTwoAdapter.insertCourse(yearTwoAdapter.getMaxId() + 1, courseNameEntered, 2, gradePercent, weight);
                        }
                        if (termSelected.getValue().equals("Third Term: Summer")) {
                            yearTwoAdapter.insertCourse(yearTwoAdapter.getMaxId() + 1, courseNameEntered, 3, gradePercent, weight);
                        }
    ...
    public void deleteCourse() throws SQLException {
        ...
        yearTwoAdapter.deleteCourse(deleteUntilCharacter(item.getValue(), '-'));
    ...
    public void editCourse() throws SQLException {
        ...
        gradeTextField.setText(String.format("%.1f", yearTwoAdapter.getPercentGrade(deleteUntilCharacter(item.getValue(), '-'))));
        weightComboBox.setValue(yearTwoAdapter.getWeight(deleteUntilCharacter(item.getValue(), '-')));
